...
excerpt: "In this post we will look at the recent advancements of Generative models name Generative Adversarial Networks (GAN). GAN can create realistic samples that resembles more like training distribution"
